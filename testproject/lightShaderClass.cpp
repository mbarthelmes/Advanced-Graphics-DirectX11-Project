...
bool LightShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	error = wcscpy_s(vsFilename, 128, L"C:/Users/matth/source/repos/testproject/testproject/light.vs");
	if (error != 0)
	{
		return false;
	}
	...
	error = wcscpy_s(psFilename, 128, L"C:/Users/matth/source/repos/testproject/testproject/light.ps");
	if (error != 0)
	{
		return false;
	}
